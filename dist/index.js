...
var TransformComponent = /** @class */ (function (_super) {
    ...
    TransformComponent.prototype.render = function () {
        var _a = this.props, children = _a.children, wrapperStyle = _a.wrapperStyle, elementStyle = _a.elementStyle;
        var _b = this.context.state, positionX = _b.positionX, positionY = _b.positionY, scale = _b.scale, _c = _b.options, wrapperClass = _c.wrapperClass, contentClass = _c.contentClass;
        var style = {
            WebkitTransform: "translate(" + positionX + "px, " + positionY + "px) scale(" + scale + ")",
            transform: "translate(" + positionX + "px, " + positionY + "px) scale(" + scale + ")",
        };
        var wrapperStyles = __assign({ width: 'fit-content', height: 'fit-content' }, wrapperStyle);
        var elementStyles = __assign({ width: 'fit-content', height: 'fit-content' }, elementStyle);
        return (React__default.createElement("div", { ref: this.wrapperRef, className: "react-transform-component " + styles.container + " " + wrapperClass, style: __assign({}, wrapperStyles) },
            React__default.createElement("div", { ref: this.contentRef, className: "react-transform-element " + styles.content + " " + contentClass, style: __assign(__assign({}, style), elementStyles) }, children)));
    };
