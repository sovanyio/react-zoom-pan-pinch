...
var TransformComponent = /** @class */ (function (_super) {
    ...
    TransformComponent.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.wrapperRef, className: "react-transform-component " + styles.container + " " + wrapperClass, style: __assign({}, wrapperStyles) },
            React.createElement("div", { ref: this.contentRef, className: "react-transform-element " + styles.content + " " + contentClass, style: __assign(__assign({}, style), elementStyles) }, children)));
    };
